...
class CryptoCipherTests: XCTestCase {
    ...
    func testTripleDESCBCKeyZero() {
        let key1 = Crypto.Data.dataFromString("")
        let key2 = Crypto.Data.dataFromString("hello there")
        let key3 = Crypto.Data.dataFromString("dude")
    ...
    func testTripleDESCBCDataZero() {
        let key1 = Crypto.Data.dataFromString("hi!")
        let key2 = Crypto.Data.dataFromString("hello there")
        let key3 = Crypto.Data.dataFromString("dude")
    ...
    func testTripleDESCBC() {
        let key1 = Crypto.Encode.dataFromBase16String("75b8ada16eb5f8ea")
        let key2 = Crypto.Encode.dataFromBase16String("253a1b793a04e03c")
        let key3 = Crypto.Encode.dataFromBase16String("75b8ada16eb5f8ea")
